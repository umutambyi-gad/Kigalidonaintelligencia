...
class Blogs(models.Model):
    ...
    first_image = models.ImageField(upload_to='blogs/images', null=True, blank=True)
    second_image = models.ImageField(upload_to='blogs/images', null=True, blank=True)
    third_image = models.ImageField(upload_to='blogs/images', null=True, blank=True)
    fourth_image = models.ImageField(upload_to='blogs/images', null=True, blank=True)
    fifth_image = models.ImageField(upload_to='blogs/images', null=True, blank=True)
